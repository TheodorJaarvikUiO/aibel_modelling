...
df.dropna(subset=[('wind_speed', '50')],inplace=True)
...
turbine = WindTurbine(turbine_type='E-53/800',hub_height=50)
...
df.to_csv("Datasets/wind_turbine_output.csv", index=True)
